      ...
      <div id="update" class="row wow fadeIn">
        ...
        <div class="col-lg-12 col-md-12 mb-12">
            ...
            <div class="card">
                <!--Card content-->
                <div class="card-body">
                    <form action="db/manage_reservation.php" method="POST">
                        ...
                        <div class="col-md-2 mb-2">
                            ...
                            <div class="mdl-selectfield">
                                ...
                                <select class="browser-default" name="month">
                                    ...
                                    <option value="08">August8</option>
                    ...
                    <tbody>
                        ...
                        while($row = $sql->fetch())  
                        {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="edit_record" data-id="<?= $row['res_id'] ?>" data-action="reservations" href=""><i class="fa fa-pencil"></i></a>
                                    <a class="delete_record" data-id="<?= $row['res_id'] ?>" data-action="reservations" href=""><i class="fa fa-remove"></i></a>
                                </td>
                            </tr>
                        <?php } ?> 
                    </tbody>
